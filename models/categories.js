const ItemsModel = require(__path_schemas + "categories"); 
...
module.exports={
    ...
    saveItem : (id, item, options = null) => {
        ...
        let slug = utilHelper.changeToSlug(item.slug)
        if(options.task == "add"){
            let created = {
                user_id: 1, 
              ...
              slug = utilHelper.changeToSlug(item.slug)
  
              item = {...item, created: created, content, slug}; 
        ...
        if(options.task == "edit"){
            let modified = {
              ...
              item = {...item, modified: modified, content, slug}; 
